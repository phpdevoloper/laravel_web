	...
	function bannerSlider() {
		if ($(".banner-slider").length > 0) {
			...
			$(".stop-slider").on("click", function () {
				bannerSlider.autoplay.stop(); // Stops the autoplay
				
				$(this).html('<i class="fa fa-play"></i>'); // Updates button text
				$(this).prop("disabled", true); // Disables the button after stopping
			});
		}
	}
