    ...
    <div class="auto-container">
        <div class="content-box">
            <div class="content-wrapper">
                <div class="title">
                    <h1 class="text-uppercase">Complaints</h1>
                </div>
...
<!-- About section -->
<section class="about-section style-two pb-20">
    <div class="auto-container">
     
        
        <div class="row">
            <h5 class="mt-2"><b>REDRESSAL OF GRIEVANCES</b></h5>
            <p class="text-dark">
            ...
            <h5 class="mt-4"><b>COMPLAINTS MONITORING AND REVIEW</b></h5>
            <p class="text-dark">
