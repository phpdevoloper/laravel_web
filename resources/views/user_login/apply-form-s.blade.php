...
<section class="apply-form">
    <div class="auto-container">
                        ...
                        <div class="apply-card-header" style="background-color: #877e85 !important;">
                            <div class="row">
                                ...
                                <div class="col-6 col-lg-4 text-md-right">
                                    <a href="{{url('assets/pdf/form_s_notes.pdf')}}" target="_blank"><i class="fa fa-download"></i> Important Notes</a>
                                </div>
        ...
        `;
                                    ...
                                    <input type="hidden" id="form_name" name="form_name" value="Form S">
